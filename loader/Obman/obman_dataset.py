...
class ObMan():
    def __init__(self,
        ...
        self.name = 'obman'
        self.cache_folder = os.path.join('data',
                                         '{}'.format(self.name))
        ...
        for side in ['left', 'right']:
            with open('mano/models/mano_faces_{}.pkl'.format(side), 'rb') as p_f:
                self.faces[side] = pickle.load(p_f)

        self.shapenet_template = 'F:/HOinter_data/ShapeNetCore/ShapeNetCore.v2/{}/{}/models/model_normalized.pkl'
        self.load_dataset()
    ...
    def load_dataset(self):
        pkl_path = 'mano/models/MANO_RIGHT.pkl'
    ...
    def get_obj_verts_faces(self, idx):
        ...
        model_path = model_path.replace(
            'F:/HOinter_data/ShapeNetCore/ShapeNetCore.v2',
            self.shapenet_root)
