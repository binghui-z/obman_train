...
import loader.Fhb_Ho3d.hodatasets.hodata as hodata
from loader.Fhb_Ho3d.hodatasets import ho3dutils
...
class HO3D(hodata.HOdata):
    ...
    def _preload(self):
        ...
        self.root_supp = os.path.join(self.data_root,"HO3D_v3", f"{self.name}_supp")

        self.cache_path = os.path.join("data", "cache", self.name)
    ...
    def load_dataset(self):
        ...
        self._preload()
        self.obj_meshes = ho3dutils.load_objects(os.path.join(self.data_root, "HO3D_v3/YCB_models_supp"))
        self.obj_normals = ho3dutils.load_obj_normals(os.path.join(self.data_root, "HO3D_v3/YCB_models_supp"))
    ...
    def load_seq_frames(self, subfolder=None, seqs=None, trainval_idx=6000):
        ...
        if self.split_mode == "paper":
            if self.data_split in ["train", "trainval", "val"]:
                ...
                subfolder = "train"
            elif self.data_split == "test":   #train序列中的.pkl文件包含手的vert和3D joints等内容，而evaluation序列中没有
